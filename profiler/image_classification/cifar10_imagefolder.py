...
parser.add_argument('train_dest', type=str, help="The path to dump the uncompressed train dataset into")
parser.add_argument('test_dest', type=str, help="The path to dump the uncompressed test dataset into")
